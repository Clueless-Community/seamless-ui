    ...
    <div>
      <div className="space-y-3">
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full bg-black ring-4 ring-black ring-offset-0 checked:ring-1 checked:ring-offset-4 checked:ring-offset-gray-400"
            type="radio"
            id="radio-5"
            name="group-1"
          />
          <label
            className="cursor-pointer select-none text-lg text-gray-300 group-hover:text-gray-500"
            htmlFor="radio-5"
          >
            {" "}
            Radio{" "}
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full outline outline-1 outline-offset-4 outline-black checked:bg-black"
            type="radio"
            id="radio-6"
            name="group-1"
          />
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full outline outline-4 outline-black checked:bg-black checked:outline-1 checked:outline-offset-4"
            type="radio"
            id="radio-7"
            name="group-1"
          />
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full bg-gray-300 shadow-blue-900 outline outline-4 outline-gray-300 checked:bg-black checked:outline-1 checked:outline-offset-4 checked:outline-black group-hover:outline-1 group-hover:outline-offset-4 group-hover:outline-black"
            type="radio"
            id="radio-8"
            name="group-1"
          />
...
// ------------Radio Blue--------------
export const RadioBlue = () => {
  return (
    <div>
      <div className="space-y-3">
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full shadow-blue-900 outline outline-1 outline-offset-4 outline-gray-300 checked:bg-blue-600 checked:outline-blue-600 group-hover:shadow group-hover:outline-blue-600"
            type="radio"
            id="radio-1"
            name="group-1"
          />
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full shadow-blue-900 outline outline-1 outline-offset-4 outline-blue-600 checked:bg-blue-600 checked:outline-blue-600 group-hover:shadow group-hover:outline-blue-600"
            type="radio"
            id="radio-2"
            name="group-1"
          />
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full shadow-blue-900 outline outline-4 outline-blue-600 checked:bg-blue-600 checked:outline-1 checked:outline-offset-4 checked:outline-blue-600 group-hover:shadow group-hover:outline-blue-600"
            type="radio"
            id="radio-3"
            name="group-1"
          />
        ...
        <div className="group flex items-center gap-4">
          <input
            className="h-3 w-3 cursor-pointer appearance-none rounded-full bg-gray-300 shadow-blue-900 outline outline-4 outline-gray-300 checked:bg-blue-600 checked:outline-1 checked:outline-offset-4 checked:outline-blue-600 group-hover:outline-1 group-hover:outline-offset-4 group-hover:outline-blue-600"
            type="radio"
            id="radio-4"
            name="group-1"
          />
