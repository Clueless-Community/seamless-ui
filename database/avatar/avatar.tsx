  ...
  return (
    <div>
      <div className="relative px-2 sm:px-0">
        <div>
          <h2 className="my-4 text-lg text-center sm:text-left font-semibold text-white">
            Avatar squared
          </h2>
          <div className="flex sm:flex-row flex-col items-center justify-center sm:space-x-10 space-y-4 sm:space-y-0">
            <img
...
export const AvatarText = () => {
  return (
    <div className=" flex flex-col items-center justify-center space-y-5 px-2">
      ...
      <div className="flex flex-col sm:flex-row items-center space-x-12">
        <img
          className="rounded-full border-2 border-gray-200 shadow-md h-40 w-40"
          src="https://mdbcdn.b-cdn.net/img/new/avatars/8.webp"
          alt=""
        />
        <div className="font-medium dark:text-blue-700 mt-2 scale-150">
          <div>Rahul Karda</div>
          <div className="text-sm text-gray-500 dark:text-gray-500">
            Joined Github in 2020
          </div>
