...
export const Testimonial9Light = () => {
  return (
    <div>
      <div className="flex items-center justify-center">
        <div className="relative w-fit rounded-2xl border bg-white pl-20 pr-11">
          <img
            ...
            alt="cover"
          />
          <h1 className="pt-11 text-2xl text-gray-900 font-bold">Rajdeep Sengupta</h1>
          ...
          <p className="w-80 pb-12 pt-5 text-gray-900 text-sm font-normal tracking-wide">
            Slate helps you see how many more days you need to work to reach.
            Slate helps you see how many more days.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center">
        <div className="relative w-fit rounded-2xl border bg-white pl-20 pr-11">
          <img
            ...
            alt="cover"
          />
          <h1 className="pt-11 text-2xl font-bold text-blue-600">
            Rajdeep Sengupta
          </h1>
          <h4 className="pt-1.5 text-sm text-gray-900 font-normal">Designer</h4>
          <div className="flex items-center gap-3.5 pt-3">
            <svg
              width="23"
              height="23"
          ...
          <p className="w-80 pb-12 text-gray-900 pt-5 text-sm font-normal tracking-wide">
            Slate helps you see how many more days you need to work to reach.
            Slate helps you see how many more days.
          </p>
        </div>
...
export const Testimonial9Dark = () => {
  return (
    <div>
      <div className="flex items-center justify-center">
        <div className="relative w-fit rounded-2xl bg-gray-900 pl-20 pr-11 text-white">
          <img
            className="absolute -left-9 top-10"
            src="https://i.ibb.co/BNfZ1sn/cover.png"
            width="80"
            alt="cover"
          />
          <h1 className="pt-11 text-2xl font-bold">Rajdeep Sengupta</h1>
          <h4 className="pt-1.5 text-sm font-normal text-gray-400">Designer</h4>
          <div className="flex items-center gap-3.5 pt-3">
            <svg
              width="23"
              height="23"
          ...
          <p className="w-80 pb-12 pt-5 text-sm font-normal tracking-wide text-gray-400">
            Slate helps you see how many more days you need to work to reach.
            Slate helps you see how many more days.
          </p>
        </div>
