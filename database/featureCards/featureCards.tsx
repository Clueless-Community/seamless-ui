  ...
  return (
    <div>
      <div className="flex w-fit flex-row items-center gap-8 rounded-2xl bg-white px-8 py-9">
        ...
        >
          <path
            d="M65.5 20.3354V76.6603C65.5 79.087 64.1654 81.2878 62.0161 82.4145C61.0627 82.9128 60.0313 83.1646 58.9956 83.1646C57.7 83.1646 56.4086 82.7743 55.295 82.0029L34.2221 67.4128C33.4854 66.8972 32.4974 66.8972 31.7564 67.4128L10.7007 82.0029C8.70735 83.3853 6.1376 83.5368 3.98394 82.4145C1.8346 81.2878 0.5 79.0827 0.5 76.6603V20.3354C0.5 9.58445 9.249 0.835449 20 0.835449H46C59 0.835449 65.5 7.33333 65.5 20.3354Z"
            fill="black"
          />
        </svg>
        <div>
...
// ------------Feature Card 0 Dark--------------
export const FeatureCard0Dark = () => {
  return (
    <div>
      <div className="flex w-fit flex-row items-center gap-8 rounded-2xl bg-gray-900 px-8 py-9">
        <svg
          width="66"
          height="84"
          viewBox="0 0 66 84"
        ...
        <div>
          <p className="text-2xl font-bold leading-8 text-white">Brand Name</p>
          <p className="mt-2 h-12 w-60 font-normal leading-4 text-gray-400">
            Slate helps you see how many more days you need ve helps you see how
            many more days.
          </p>
        </div>
...
export const FeatureCard1Light = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center gap-2 rounded-2xl bg-[#FEFEFE] px-6 py-8 transition-all duration-500 ease-in-out hover:shadow-gray-900/20">
        <svg
          width="70"
          height="70"
          viewBox="0 0 70 70"
...
// ------------Feature Card 1 Blue--------------
export const FeatureCard1Blue = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center gap-2 rounded-2xl bg-[#FEFEFE] px-6 py-8 transition-all duration-500 ease-in-out hover:shadow-slate-900/20">
        <svg
          width="70"
          height="70"
          viewBox="0 0 70 70"
        ...
        <button className="mt-2 rounded-full bg-blue-600 hover:bg-blue-700 px-8 py-2 text-center font-sans text-lg font-normal text-white transition-all">
          Try for free
        </button>
        <img
          className="h-48 mt-8"
...
// ------------Feature Card 1 Dark--------------
export const FeatureCard1Dark = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center gap-2 rounded-2xl bg-gray-900 px-6 py-8 transition-all duration-500 ease-in-out hover:shadow-slate-900/20">
        <svg
          width="70"
          height="70"
          viewBox="0 0 70 70"
        ...
        <p className="mt-2 w-60 text-center text-sm font-normal leading-5 text-gray-400">
          Slate helps you see how many more days you need to work to reach.
          Slate helps you see how many more days.
        </p>
        <button className="mt-2 rounded-full bg-white hover:bg-gray-300 px-8 py-2 text-lg font-normal text-gray-900 transition-all disabled:bg-gray-400">
          Try for free
        </button>
        <img
          className="h-48 mt-8"
...
// ------------Feature Card 2 Light--------------
export const FeatureCard2Light = () => {
  return (
    <div>
      <div className="w-72 rounded-2xl bg-white px-9 py-10 transition-all duration-500 hover:scale-105 hover:shadow-xl hover:shadow-slate-900/30">
        <svg
          width="53"
          height="47"
          viewBox="0 0 53 47"
...
// ------------Feature Card 2 Blue--------------
export const FeatureCard2Blue = () => {
  return (
    <div>
      <div className="w-72 rounded-2xl bg-white px-9 py-10 transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-xl hover:shadow-slate-900/30">
        <svg
          width="53"
          height="47"
          viewBox="0 0 53 47"
        ...
        <p className="mt-5 text-2xl font-bold leading-8 text-blue-600">
          At your fingertips
        </p>
        <p className="mt-2.5 w-52 text-sm font-normal leading-4 text-black">
          Slate helps you see how many more days you need to work to reach.
        ...
        <button className="mt-6 rounded-full border-2 border-blue-600 px-8 py-2.5 text-sm font-semibold text-blue-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:shadow-lg hover:shadow-blue-600/40">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 2 Dark--------------
export const FeatureCard2Dark = () => {
  return (
    <div>
      <div className="w-72 rounded-2xl bg-gray-900 px-9 py-10 transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-xl hover:shadow-slate-900/30">
        <svg
          width="53"
          height="47"
          viewBox="0 0 53 47"
        ...
        <p className="mt-5 text-2xl font-bold leading-8 text-white">
          At your fingertips
        </p>
        <p className="mt-2.5 w-52 text-sm font-normal leading-4 text-gray-400">
          Slate helps you see how many more days you need to work to reach.
          Slate helps you see how many more days.
        </p>
        <button className="mt-6 rounded-full border-2 px-8 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-white hover:text-gray-900 hover:shadow-lg hover:shadow-white/40">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 3 Light--------------
export const FeatureCard3Light = () => {
  return (
    <div>
      <div className="w-fit rounded-2xl bg-white px-6 py-7 transition-all duration-500 ease-in-out">
        <h1 className="mb-5 text-2xl font-bold leading-8 text-black">
          Job Security
        </h1>
        <p className="word-wrap: break-word mb-5 w-44 leading-4 text-gray-600">
          Slate helps you see how many more days you need to work to reach.
        </p>
        <button className="rounded-full border-2 border-black px-8 py-1.5 text-lg font-medium text-black transition-all hover:bg-black hover:text-white/90 hover:shadow-lg hover:shadow-black/30 disabled:bg-gray-400 disabled:text-white disabled:opacity-75">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 3 Blue--------------
export const FeatureCard3Blue = () => {
  return (
    <div>
      <div className="w-fit rounded-2xl bg-white px-6 py-7 transition-all duration-500 ease-in-out">
        <div className="mb-5 text-2xl font-bold leading-8 text-blue-600">
          Job Security
        </div>
        <p className="word-wrap: break-word mb-5 text-gray-900 w-44 leading-4">
          Slate helps you see how many more days you need to work to reach.
        </p>
        <button className="border-white-90 rounded-full border-2 border-blue-600 px-8 py-1.5 text-lg font-medium text-blue-600 transition-all hover:bg-blue-600 hover:text-white hover:shadow-lg hover:shadow-blue-600/30 disabled:bg-gray-400 disabled:text-white disabled:opacity-75">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 3 Dark--------------
export const FeatureCard3Dark = () => {
  return (
    <div>
      <div className="w-fit rounded-2xl bg-gray-900 px-6 py-7 transition-all duration-500 ease-in-out">
        <h1 className="mb-5 text-2xl font-bold leading-8 text-white">
          Job Security
        </h1>
        <p className="word-wrap: break-word mb-5 w-44 leading-4 text-gray-400">
          Slate helps you see how many more days you need to work to reach.
        </p>
        <button className="border-white-90 rounded-full border-2 px-8 py-1.5 text-lg font-medium text-white/90 transition-all hover:bg-white hover:text-black hover:shadow-lg hover:shadow-white/40 disabled:bg-gray-400 disabled:text-white disabled:opacity-75">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 4 Light--------------
export const FeatureCard4Light = () => {
  return (
    <div>
      <div className="flex w-fit rounded-2xl bg-white py-5 pl-5 pr-8">
        ...
        <div>
          <p className="ml-5 mt-1 text-3xl font-bold leading-8 text-black">
            2680
          </p>
          <p className="ml-5 text-sm font-normal leading-4 tracking-wide text-gray-600">
            Happy Clients
          </p>
        </div>
      </div>
  ...
  return (
    <div className="cursor-default">
      <div className="flex w-fit rounded-2xl bg-white py-5 pl-5 pr-8">
        ...
        <div>
          <p className="ml-5 mt-1 text-3xl font-bold leading-8 text-blue-600">
            2680
          </p>
          <p className="ml-5 text-sm font-normal leading-4 tracking-wide text-black">
            Happy Clients
          </p>
        </div>
      </div>
...
// ------------Feature Card 4 Dark--------------
export const FeatureCard4Dark = () => {
  return (
    <div className="cursor-default">
      <div className="flex w-fit rounded-2xl bg-gray-900 py-5 pl-5 pr-8">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
        ...
        <div>
          <p className="ml-5 mt-1 text-3xl font-bold leading-8 text-white">
            2680
          </p>
          <p className="ml-5 text-sm font-normal leading-4 tracking-wide text-gray-400">
            Happy Clients
          </p>
        </div>
      </div>
...
export const FeatureCard8Light = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-white px-7 py-6 shadow-slate-900 duration-300 ease-in-out hover:scale-105 hover:drop-shadow-md">
        <svg
          width="54"
          height="60"
          viewBox="0 0 54 60"
        ...
        <h1 className="mt-4 text-2xl font-bold leading-8 tracking-wide text-black">
          Security
        </h1>
      </div>
    </div>
    ...
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-white px-7 py-6 shadow-slate-900 duration-300 ease-in-out hover:scale-105 hover:drop-shadow-md">
        ...
        >
          ...
          >
            <path
              d="M52.4167 13.8893C52.4167 39.6691 48.6951 52.2367 26.6338 58.5359C26.4951 58.576 26.3532 58.5977 26.2113 58.5977C26.0695 58.5977 25.9278 58.576 25.789 58.5359C3.72471 52.2305 0 39.7921 0 14.2868C0 13.5961 0.459459 12.9919 1.12238 12.8038C12.9716 9.45841 21.9965 3.5881 25.1723 0.455436C25.4653 0.168686 25.8784 -0.0534469 26.2669 0.0113031C26.6739 0.0143864 27.0654 0.180658 27.3522 0.470491C30.2227 3.38116 42.3404 9.41209 51.3622 12.4214C51.9912 12.6373 52.4167 13.2264 52.4167 13.8893Z"
              fill="#1855CB"
            />
          </svg>
        </svg>
        <h1 className="mt-4 text-2xl font-bold leading-8 tracking-wide text-blue-600">
          Security
        </h1>
      </div>
    </div>
...
// ------------Feature Card 8 Dark--------------
export const FeatureCard8Dark = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-gray-900 px-7 py-6 shadow-slate-900 duration-300 ease-in-out hover:scale-105 hover:drop-shadow-md">
        <svg
          width="54"
          height="60"
          viewBox="0 0 54 60"
        ...
        <h1 className="mt-4 text-2xl font-bold leading-8 tracking-wide text-white">
          Security
        </h1>
      </div>
    </div>
...
// ------------Feature Card 10 Light--------------
export const FeatureCard10Light = () => {
  return (
    <div>
      <div className="w-fit flex cursor-default rounded-2xl  px-6 py-5 transition-all duration-500 ease-in-out  hover:shadow-slate-900/20 items-center justify-s bg-white gap-4">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
...
// ------------Feature Card 10 Blue--------------
export const FeatureCard10Blue = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default rounded-2xl  items-center bg-white gap-4 px-6 py-5 ">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
...
// ------------Feature Card 10 Dark--------------
export const FeatureCard10Dark = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default items-center gap-4 rounded-2xl bg-gray-900 px-6 py-5">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
    ...
    <div>
      <div className="flex-col w-fit cursor-default rounded-2xl  bg-white gap-4 px-8 py-5 transition-all ease-out duration-500 hover:cursor-pointer hover:shadow-xl hover:scale-105">
        <svg
          ...
          viewBox="0 0 24 24"
          fill="currentColor"
          className="w-10 h-10 stroke-blue-600 mx-auto"
        >
          <path
            fill="#2D70F3"
        ...
        <p className="text-2xl font-bold  leading-8 mt-2 text-blue-600 text-center">
          Get link
        </p>
      </div>
    </div>
  ...
  return (
    <div>
      <div className="w-fit flex cursor-pointer flex-col justify-centercursor-default rounded-2xl  px-8 py-5 transition-all duration-500 ease-in-out  hover:shadow-slate-900/20 items-center justify-s bg-gray-900 gap-4">
        ...
        >
          <path
            d="M28.6889 13.1374L25.8522 15.9738C25.2491 16.5766 24.2742 16.5766 23.671 15.9738C23.0679 15.371 23.0679 14.397 23.671 13.7942L26.5078 10.9574C28.2863 9.17828 28.2863 6.28452 26.5078 4.5039C24.7832 2.77877 21.7768 2.77877 20.0538 4.5039L14.8724 9.68256C14.6904 9.86447 14.5515 10.0308 14.4605 10.1696C13.0753 12.0566 13.2712 14.5342 14.8739 16.136C15.4755 16.7388 15.4755 17.7144 14.8739 18.3157C14.5731 18.6163 14.1783 18.7673 13.7834 18.7673C13.3885 18.7673 12.9936 18.6163 12.6912 18.3157C10.0041 15.6285 9.68176 11.4662 11.9231 8.41828C12.082 8.17008 12.3487 7.84479 12.6896 7.50254L17.8727 2.32238C19.3165 0.877836 21.2385 0.0825195 23.2808 0.0825195C25.3231 0.0825195 27.2451 0.879378 28.6905 2.32238C31.6707 5.3055 31.6707 10.1558 28.6889 13.1374ZM16.145 12.6842C15.5419 13.287 15.5419 14.2611 16.145 14.8639C17.4053 16.1234 17.8171 17.9412 17.2063 19.6402C17.0042 20.246 16.6371 20.827 16.145 21.3188L10.9636 26.4975C9.24057 28.2226 6.23413 28.2226 4.50956 26.4975C2.73101 24.7184 2.73101 21.8246 4.50956 20.044L7.34628 17.2072C7.94942 16.6044 7.94942 15.6304 7.34628 15.0276C6.74315 14.4248 5.76826 14.4248 5.16512 15.0276L2.3284 17.864C-0.653332 20.8456 -0.653332 25.6959 2.3284 28.6775C3.77377 30.122 5.69426 30.9174 7.73813 30.9174C9.782 30.9174 11.7024 30.1205 13.1463 28.6775L18.3277 23.4988C19.1576 22.6679 19.7823 21.6706 20.1217 20.6485C21.1136 17.892 20.4101 14.767 18.3262 12.6842C17.7246 12.0814 16.7466 12.0814 16.145 12.6842Z"
            fill="white"
          />
        </svg>
        <p className="text-2xl font-bold text-white text-center ">Get link </p>
      </div>
    </div>
  );
};

// ------------Feature Card 12 Light--------------
export const FeatureCard12Light = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-white px-12 py-10 transition-all duration-500 ease-out">
        <svg
          width="65"
          height="65"
          viewBox="0 0 65 65"
...
// ------------Feature Card 12 Blue--------------
export const FeatureCard12Blue = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-white px-12 py-10 transition-all duration-500 ease-out">
        <svg
        ...
        <p className="mt-5 text-center text-sm font-normal leading-4 text-gray-500">
          email@gmail.com
        </p>
        <p className="mt-3.5 text-center text-blue-600 text-2xl font-bold leading-8 ">
          Get a Pie
        </p>
        <button className="mt-8 rounded-full border-2 border-blue-600 px-6 py-1 text-lg font-normal text-blue-600 transition-all hover:bg-blue-600 hover:text-white disabled:bg-gray-400">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 12 Dark--------------
export const FeatureCard12Dark = () => {
  return (
    <div>
      <div className="flex w-fit cursor-default flex-col items-center justify-center rounded-2xl bg-gray-900 px-12 py-10 transition-all duration-500 ease-out">
        <svg
          width="65"
          height="65"
          viewBox="0 0 65 65"
        ...
        <p className="mt-3.5 text-center text-2xl font-bold leading-8 text-white">
          Get a Pie
        </p>
        <button className="mt-8 rounded-full border-2 border-white px-6 py-1 text-lg font-normal text-white transition-all hover:bg-white hover:text-black disabled:bg-gray-400">
          Button
        </button>
      </div>
    </div>
...
// ------------Feature Card 13 Light--------------
export const FeatureCard13Light = () => {
  return (
    <div>
      <div className="flex w-fit flex-col items-center justify-center gap-4 rounded-2xl bg-white px-6 py-10 transition-all">
        <svg
          width="57"
          height="66"
          viewBox="0 0 57 66"
...
// ------------Feature Card 13 Blue--------------
export const FeatureCard13Blue = () => {
  return (
    <div>
      <div className="flex w-fit flex-col items-center justify-center gap-4 rounded-2xl bg-white px-6 py-10 transition-all">
        <svg
        ...
        <div className="flex w-56 flex-col gap-1 text-center">
          ...
          <p className="mb-2 mt-1 px-4 text-sm leading-4 text-gray-600">
            Slate helps you see how many more days you need to work to reach.
            Slate helps you see how many more.
          </p>
        </div>
        <button className="text-bg-gray-200 rounded-full bg-blue-600 px-6 py-2 text-center font-sans text-sm font-normal text-white transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-white/20 disabled:bg-gray-400">
          Try for free
        </button>
      </div>
    </div>
    ...
    <div>
      <div className="flex w-fit flex-col items-center justify-center gap-4 rounded-2xl bg-gray-900 px-6 py-10 transition-all">
        ...
        <div className="flex w-56 flex-col gap-1 text-center">
          ...
          <p className="mb-2 mt-1 px-3 text-sm font-normal leading-4 text-gray-400">
            Slate helps you see how many more days you need to work to reach.
            Slate helps you see how many more days.
          </p>
        </div>
        <button className="text-bg-gray-200 rounded-full bg-white px-6 py-2 text-center font-sans text-sm font-normal text-black transition-all hover:bg-white/90 hover:shadow-lg hover:shadow-white/20 disabled:bg-gray-400">
          Try for free
        </button>
      </div>
    </div>
...
// ------------Feature Card 14 Light--------------
export const FeatureCard14Light = () => {
  return (
    <div>
      <div className="flex w-fit flex-row items-center gap-4 rounded-2xl bg-white px-6 py-7">
        <svg
          width="58"
          height="54"
          viewBox="0 0 58 54"
...
// ------------Feature Card 14 Blue--------------
export const FeatureCard14Blue = () => {
  return (
    <div>
      <div className="flex w-fit flex-row items-center gap-4 rounded-2xl bg-white px-6 py-7">
        <svg
...
// ------------Feature Card 14 Dark--------------
export const FeatureCard14Dark = () => {
  return (
    <div>
      <div className="flex w-fit flex-row items-center gap-4 rounded-2xl bg-gray-900 px-6 py-7">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
...
// ------------Feature Card 15 Light--------------
export const FeatureCard15Light = () => {
  return (
    <div>
      <div className="w-fit flex flex-col  cursor-default rounded-2xl  px-9 py-6  bg-white gap-2">
        <svg
          width="53"
          height="59"
          viewBox="0 0 53 59"
        ...
        >
          <path
            d="M52.4167 13.8893C52.4167 39.6691 48.6951 52.2367 26.6338 58.5359C26.4951 58.576 26.3532 58.5976 26.2113 58.5976C26.0695 58.5976 25.9278 58.576 25.789 58.5359C3.72471 52.2305 0 39.7921 0 14.2868C0 13.5961 0.459459 12.9919 1.12238 12.8038C12.9716 9.45841 21.9965 3.5881 25.1723 0.455436C25.4653 0.168686 25.8784 -0.0534469 26.2669 0.0113031C26.6739 0.0143864 27.0654 0.180658 27.3522 0.470491C30.2227 3.38116 42.3404 9.41208 51.3622 12.4214C51.9912 12.6373 52.4167 13.2264 52.4167 13.8893Z"
            fill="black"
          />
        </svg>
        <h1 className="text-2xl font-bold text-black leading-8">
          Job Security
        </h1>
...
// ------------Feature Card 15 Blue--------------
export const FeatureCard15Blue = () => {
  return (
    <div>
      <div className="w-fit flex flex-col  cursor-default rounded-2xl  px-9 py-6  bg-white gap-2">
        <svg
        ...
        <h1 className="text-2xl font-bold text-blue-600 leading-8">
          Job Security
        </h1>
        <p className="text-sm font-normal text-gray-600 text-center ">
          the quick fox jumps over the lazy dog{" "}
...
// ------------Feature Card 15 Dark--------------
export const FeatureCard15Dark = () => {
  return (
    <div>
      <div className="w-fit flex  flex-col  cursor-default rounded-2xl  px-8 py-6 transition-all duration-500 ease-in-out  hover:shadow-slate-900/20  bg-gray-900 gap-2">
        <svg
          width="53"
          height="59"
          viewBox="0 0 53 59"
...
// ------------Feature Card 16 Light--------------
export const FeatureCard16Light = () => {
  return (
    <div>
      <div className="w-fit cursor-default items-center gap-4 rounded-2xl bg-white px-5 py-6">
        <div className="ml-4 flex flex-row">
          ...
          <p className="ml-5 mt-1 text-2xl font-semibold leading-8 text-black">
            New UI Ideas
          </p>
        </div>
...
// ------------Feature Card 16 Blue--------------
export const FeatureCard16Blue = () => {
  return (
    <div>
      <div className="w-fit cursor-default items-center gap-4 rounded-2xl bg-white px-5 py-6">
        <div className="ml-4 flex flex-row">
          ...
          <p className="ml-5 mt-1 text-2xl font-semibold leading-8 text-blue-600">
            New UI Ideas
          </p>
        </div>
        <p className="mb-5 ml-4 mt-2 h-12 w-72 font-normal leading-5 text-gray-600">
...
// ------------Feature Card 16 Dark--------------
export const FeatureCard16Dark = () => {
  return (
    <div>
      <div className="w-fit cursor-default items-center gap-4 rounded-2xl bg-gray-900 px-5 py-6">
        <div className="ml-4 flex flex-row">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          <p className="ml-5 mt-1 text-2xl font-semibold leading-8 text-white">
            New UI Ideas
          </p>
        </div>
