...
<button class="text-bg-gray-200 rounded-full bg-slate-900 px-4 py-2 text-center font-sans text-sm font-normal text-white transition-all hover:bg-black disabled:bg-gray-400">Button</button>

<!-- Medium -->

<button class="text-bg-gray-200 rounded-full bg-slate-900 px-8 py-2.5 text-center font-sans text-lg font-normal text-white transition-all hover:bg-black disabled:bg-gray-400">Button</button>

<!-- Large -->

<button class="text-bg-gray-200 rounded-full bg-slate-900 px-10 py-3 text-center font-sans text-2xl font-normal text-white transition-all hover:bg-black disabled:bg-gray-400">Button</button>
