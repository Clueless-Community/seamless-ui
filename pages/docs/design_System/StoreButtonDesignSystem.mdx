...
<div class="flex">
<img width='260' src="https://i.ibb.co/6XjFGcX/image.png"/>
<img width='260' src="https://i.ibb.co/5KWnbfY/image.png"/>
<img width='260' src="https://i.ibb.co/W2q4fLs/image.png"/>
</div>
...
The normal border-radius for the components are `rounded-xl`. However this does not apply in many cases like buttons, input boxes and all.
