            ...
            <div className="flex md:flex-row flex-col-reverse justify-between items-center md:px-36 -mt-40 md:-mb-28 py-10">
                <div className="mb-28 md:mb-0 p-4">
                    ...
                    <div className="gap-0">
                        ...
                        <input placeholder="Enter the Email" className=" border-2 w-full border-[#7EE787] md:p-3 p-1 rounded-lg my-3 index-bg"></input>
                    </div>
                    <div>

                        <p className="text-white -mb-2">Subject</p>
                        <input placeholder="Enter the Subject" className="border-2 w-full border-[#7EE787] md:p-3  p-1 rounded-lg my-3 index-bg "></input>
                    </div>
                    <div>
                        ...
                        <input placeholder="How can we help you" className="border-2 w-full border-[#7EE787] md:p-3 p-1  rounded-lg my-3 md:pb-28  index-bg pb-28"></input>
                    </div>
                </div>
                <img src="/input.png" className="md:w-7/12 md:mb-40 w-full  -ml-20 my-28 md:my-0" />
            </div>
        </div>
        <Footer />
    </div>
