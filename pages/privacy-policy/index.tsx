    ...
    <div className="relative flex flex-col justify-center items-center ">
      <div className="md:px-24 px-7 py-24  text-justify">
        ...
        <p className="text-white pb-10 text-lg">
          ...
          shared and/or collect in ClueLess. This policy is not applicable to
        ...
        <div className=" text-white mb-10">
          <ul className="text-lg">1. Provide, operate, and maintain our website</ul>
          <ul className="text-lg">2. Improve, personalize, and expand our website</ul>
          <ul className="text-lg">3. Understand and analyze how you use our website</ul>
          ...
          <ul className="text-lg">6. Send you emails</ul>
          <ul className="text-lg">7. Find and prevent fraud</ul>{" "}
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          information. For more general information on cookies, please read more
          on the Cookie Consent website.
        </p>
        <h1 className="text-white font-semibold text-2xl underline pb-5">
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          on ClueLess, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that ClueLess has no
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          to opt-out of certain options. ClueLess's Privacy Policy does not
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options. Under the CCPA, among other rights,
          California consumers have the right to: ClueLess's Privacy Policy does
          ...
          servers for more detailed information. It may include their practices
          and instructions about how to opt-out of certain options. Request that
          a business that collects a consumer's personal data disclose the
          categories and specific pieces of personal data that a business has
          collected about consumers. ClueLess's Privacy Policy does not apply to
          ...
          instructions about how to opt-out of certain options. Request that a
          business delete any personal data about the consumer that a business
          has collected. ClueLess's Privacy Policy does not apply to other
          advertisers or websites. Thus, we are advising you to consult the
          respective Privacy Policies of these third-party ad servers for more
          detailed information. It may include their practices and instructions
          about how to opt-out of certain options. Request that a business that
          sells a consumer's personal data, not sell the consumer's personal
          data. ClueLess's Privacy Policy does not apply to other advertisers or
          websites. Thus, we are advising you to consult the respective Privacy
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options. If you make a request, we have one
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options. We would like to make sure you are
          fully aware of all of your data protection rights. Every user is
          entitled to the following: ClueLess's Privacy Policy does not apply to
          other advertisers or websites. Thus, we are advising you to consult
          the respective Privacy Policies of these third-party ad servers for
          more detailed information. It may include their practices and
          instructions about how to opt-out of certain options. The right to
          access – You have the right to request copies of your personal data.
          We may charge you a small fee for this service. ClueLess's Privacy
          ...
          options. The right to rectification – You have the right to request
          ...
          is incomplete. ClueLess's Privacy Policy does not apply to other
          advertisers or websites. Thus, we are advising you to consult the
          respective Privacy Policies of these third-party ad servers for more
          detailed information. It may include their practices and instructions
          about how to opt-out of certain options. The right to erasure – You
          have the right to request that we erase your personal data, under
          certain conditions. ClueLess's Privacy Policy does not apply to other
          advertisers or websites. Thus, we are advising you to consult the
          respective Privacy Policies of these third-party ad servers for more
          detailed information. It may include their practices and instructions
          about how to opt-out of certain options. The right to restrict
          processing – You have the right to request that we restrict the
          processing of your personal data, under certain conditions. ClueLess's
          ...
          certain options. The right to object to processing – You have the
          right to object to our processing of your personal data, under certain
          conditions. ClueLess's Privacy Policy does not apply to other
          advertisers or websites. Thus, we are advising you to consult the
          respective Privacy Policies of these third-party ad servers for more
          detailed information. It may include their practices and instructions
          about how to opt-out of certain options. The right to data portability
          ...
          respective Privacy Policies of these third-party ad servers for more
          detailed information. It may include their practices and instructions
          about how to opt-out of certain options. If you make a request, we
        ...
        <p className="text-white pb-10 text-lg   ">
          ...
          Policies of these third-party ad servers for more detailed
          information. It may include their practices and instructions about how
          to opt-out of certain options. Another part of our priority is adding
          ...
          their online activity. ClueLess's Privacy Policy does not apply to
          other advertisers or websites. Thus, we are advising you to consult
          the respective Privacy Policies of these third-party ad servers for
          more detailed information. It may include their practices and
          instructions about how to opt-out of certain options. ClueLess does
