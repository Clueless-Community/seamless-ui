    ...
    <div className="text-white text-centre flex  flex-col-reverse md:flex-row  justify-between  relative mt-20">
      <div className="text-centre md:p-20 p-9">
        <div className="flex space-x-5  ">
          ...
          <h1 className=" text-4xl text-[#7EE787] hidden md:block ">
            SeamLess UI Figma
          </h1>
        </div>
        ...
        <a href="" target="_blank" rel="noreferrer">
          <button className="text-[#7EE787] text-2xl flex items-center justify-center hover:underline pl-28 md:pl-0  hover:bg-green-800 transition-all">
            Explore{" "}
            <svg
      ...
      <img
        ...
        draggable={false}
      />
      <h1 className=" text-3xl text-[#7EE787] text-center md:hidden">
        SeamLess UI Figma
      </h1>
    </div>
  );
