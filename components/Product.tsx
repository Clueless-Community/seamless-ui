...
function Product() {
    return (
        <div className='relative mt-20'>
            <h1 className='text-4xl text-[#7EE787] md:pl-20 text-center md:text-left '>A Product by ClueLess</h1>
            <div className='flex flex-col md:flex-row justify-between items-center md:gap-36 md:px-20 md:py-20'>
                ...
                <div className=' flex flex-col items-center md:items-start'>
                    <p className='text-white text-xl text-center mt-10 md:mt-0 md:text-left '>Built with the vision to encourage open-source enthusiasts!
