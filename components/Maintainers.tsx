  ...
  return (
    <div className="relative mt-20">
      <div className="flex  flex-col md:flex-row md:justify-between items-center p-15  ">
        <h1 className="text-4xl text-[#7EE787] md:pl-20  text-center">
      ...
      <div>
        <div className="flex justify-between items-center mt-20 flex-col lg:flex-row">
          <div className=" flex  flex-col md:flex-row relative bg-[#282E36] md:p-10 mx-6 md:w-[600px] lg:w-[500px] xl:w-[600px] rounded-xl  ring-1 ring-white md:ml-20  mb-10">
            <div className="p-9 md:p-0">
              <div className="flex justify-between flex-col-reverse md:flex-row text-center items-center md:text-left ">
                ...
                <img src="Ellipse 58.png" className="w-16 lg:mr-10 xl:mr-0" draggable={false} />
              </div>
              <div className="h-0.5 w-full bg-gray-700 my-5"></div>
              <p className="text-white text-lg text-center md:text-left mb-4 md:mb-0  ">
      ...
      <div className="flex flex-col-reverse lg:flex-row mt-7 justify-center items-center lg:items-end lg:justify-end lg:mr-60 gap-10">
        <h1 className="text-4xl text-[#7EE787] lg:pl-32 whitespace-nowrap lg:mt-40 mt-5">
          Meet the maintainers
        </h1>
        <img
          src="/pipe.png"
          className="w-80 xl:w-96 hidden lg:block "
          draggable={false}
        />
        <img src="/Group 273.png" className="lg:hidden h-36 w-5.5" />
      </div>
    </div>
  );
}
